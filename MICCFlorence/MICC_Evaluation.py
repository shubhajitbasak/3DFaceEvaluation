...
class MICC_Benchmark():
    ...
    def point2plane_ICP(self, reg, rec, tight_mask):
        ...
        while pre_dist - dist > 0.001:
            lm_align = AlignmentSimilarity(PointCloud(reg.from_mask(mask).points),
                                           PointCloud(rec_closest)).as_non_alignment()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--reconstruction_path", default='/mnt/sata/data/Florence/FlorenceFace/Pred_Swin_Tiny',
